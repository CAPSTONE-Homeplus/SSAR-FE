    ...
    if (!introRef.current) {
      ...
      introRef.current.setOptions({
        steps: [
          ...
          { element: "#header", intro: "🚀 Đây là thanh header chứa logo và menu chính." },
          { element: "#avatar", intro: "👤 Đây là avatar người dùng. Nhấn vào để xem thông tin cá nhân." },
          { element: "#dark-mode", intro: "🌙 Đây là nút chuyển đổi Dark Mode." },
          { element: "#chat-box", intro: "💬 Đây là chat box để bạn trò chuyện với hỗ trợ viên." },
        ],
        showProgress: true,
        showBullets: true,
