...
import ServiceActivityDetailAsync from "@/app/(dashboard)/manager/services/[slug]/_components/list-service-activities-in-service/[slug]/_components/update/service-activity-detail-async";

type Props = {
  slug: string;
  keyProps: string;
};
const ServiceActivityIndex = ({ slug, keyProps }: Props) => {
  return (
    <PageContainer>
...
export default ServiceActivityIndex;
